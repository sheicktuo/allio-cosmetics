...
CREATE TABLE "BusinessSettings" (
    "id" TEXT NOT NULL,
    "businessName" TEXT NOT NULL DEFAULT 'Allio Cosmetics',
    "logoUrl" TEXT,
    "tagline" TEXT,
    "email" TEXT,
    "phone" TEXT,
    ...
    "stripePublishKey" TEXT,
    "stripeSecretKey" TEXT,
    "stripeWebhookKey" TEXT,
    "resendApiKey" TEXT,
    "pusherAppId" TEXT,
    "pusherKey" TEXT,
    "pusherSecret" TEXT,
...
-- CreateIndex
CREATE INDEX "CustomRequestItem_requestId_idx" ON "CustomRequestItem"("requestId");
...
-- AddForeignKey
ALTER TABLE "CustomRequestItem" ADD CONSTRAINT "CustomRequestItem_requestId_fkey" FOREIGN KEY ("requestId") REFERENCES "CustomRequest"("id") ON DELETE CASCADE ON UPDATE CASCADE;

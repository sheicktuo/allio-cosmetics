...
const STEPS = ["Contact", "Your Bottle", "Delivery", "Review"]

const ORDER_TYPES = [
  {
    value: "MAIL_IN",
    label: "Mail In",
    description: "Ship your bottle to us. We return it insured.",
    emoji: "📦",
  },
  {
    value: "DROPOFF",
    label: "Drop Off",
    description: "Bring your bottle to our London studio.",
    emoji: "🏪",
  },
  {
    value: "PICKUP",
    label: "We Collect",
    description: "We pick up from your address (London only).",
    emoji: "🚗",
  },
]
...
export default function CheckoutPage() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      // placeOrder redirects on success — an error here means something went wrong
            ...
            <div className="bg-card border border-border rounded-2xl p-8">
                ...
                <div className="space-y-5">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      No account needed.{" "}
                      <Link href="/login?from=/checkout" className="text-primary hover:underline font-medium">
                        Sign in
                      </Link>{" "}
              ...
              {step === 2 && (
                <div className="space-y-6">
                  ...
                  <Field label="Promo code" hint="Optional">
                    <input value={delivery.promoCode} onChange={(e) => setDelivery({ ...delivery, promoCode: e.target.value })}
              ...
              {step === 3 && (
                <div className="space-y-6">
                  ...
                  <hr className="border-border" />
                  <ReviewRow label="Delivery method" value={ORDER_TYPES.find((t) => t.value === delivery.orderType)?.label ?? ""} />
          ...
          <div className="lg:col-span-1">
            <div className="bg-card border border-border rounded-2xl p-6 sticky top-24">
              ...
              <p className="text-xs text-muted-foreground mt-3 leading-relaxed">
                Payment is collected after your assessment. We&apos;ll confirm costs before any work begins.
              </p>
            </div>
          </div>
        </div>

...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* ── Hero ─────────────────────────────────────────────────────── */}
      <section className="relative bg-gradient-to-br from-background via-muted to-accent overflow-hidden">
      ...
      <section className="py-20 bg-card border-y border-border">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <div className="aspect-square bg-gradient-to-br from-primary/20 via-muted to-accent rounded-3xl flex items-center justify-center text-9xl">
                🌹
              </div>
            </div>
            ...
            {milestones.map((m, i) => (
              <div key={m.year} className="flex gap-6">
                <div className="flex flex-col items-center">
                  <div className="w-10 h-10 rounded-full bg-primary text-primary-foreground flex items-center justify-center font-heading font-bold text-xs flex-shrink-0">
                    {m.year.slice(2)}
                  </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {team.map((member) => (
              ...
              >
                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-primary/20 to-muted flex items-center justify-center text-4xl mx-auto mb-4">
                  {member.emoji}
                </div>

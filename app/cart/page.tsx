          ...
          <div className="grid lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-2 space-y-4">
              {items.map((item) => (
                ...
                >
                  {/* Emoji image */}
                  <div className="w-16 h-16 flex-shrink-0 bg-gradient-to-br from-primary/15 via-muted to-accent rounded-xl flex items-center justify-center text-3xl">
                    {item.emoji}
                  </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-card border border-border rounded-2xl p-6 sticky top-24">
                ...
                <div className="space-y-3 text-sm mb-6">
                  ...
                  {freeReturns && (
                    <div className="flex items-center gap-2 text-green-600 dark:text-green-400 text-xs pt-1">
                      <span>✓</span>
                ...
                <div className="border-t border-border pt-4 mb-6">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">Includes VAT</p>
                </div>
